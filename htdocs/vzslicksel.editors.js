...
(function ($) {
  ...
  function TextEditor(args) {
    ...
    var defaultValue;
    var scope = this;
    var lacolu=grid.getActiveCell().cell
    var ancho=ajsmaxlen[lacolu]

    //alert("ancho "+ancho )

    this.init = function () {
      $input = $("<INPUT type=text class='editor-text' MAXLENGTH="+ancho+" />")
  ...
  function IntegerEditor(args) {
    ...
    this.init = function () {
      $input = $("<INPUT type=text class='editor-text' onKeyDown='return maskInputTo(this,12,3)' />");
    ...
    this.serializeValue = function () {
      return parseFloat($input.val()).toFixed(3) || 0;
    };
...
var isDot=((190==event.keyCode ||110==event.keyCode)&&(new String(inputElement.value).indexOf(".")<=0)) ; // dot
var k=String.fromCharCode(event.keyCode);
//alert(event.keyCode+" es "+k);
var sel, rng, r2, curPos=-1;

if (event.keyCode==96) k=0;
if (event.keyCode==97) k=1;
if (event.keyCode==98) k=2;
if (event.keyCode==99) k=3;
if (event.keyCode==100) k=4;
if (event.keyCode==101) k=5;
if (event.keyCode==102) k=6;
if (event.keyCode==103) k=7;
if (event.keyCode==104) k=8;
if (event.keyCode==105) k=9;
